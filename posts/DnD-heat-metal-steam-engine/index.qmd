...
The color of the "red hot" or "white hot" state is governed by **Black Body Radiation**. According to **Planck's Law**, the peak wavelength (color) is determined solely by the temperature, not the material.

### Wien's Displacement Law
$$\lambda_{max} = \frac{b}{T}$$

At $2000^\circ\text{C}$ ($2273\text{ K}$), the peak wavelength $\lambda_{max} \approx 1.27\text{ }\mu\text{m}$. The distribution covers the entire visible spectrum, emitting all colors nearly equally. This is why a Copper pipe and a Tungsten pipe at $900^\circ\text{C}$ will both emit the exact same "Bright Red" hue.
